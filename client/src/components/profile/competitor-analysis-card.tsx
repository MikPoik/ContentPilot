...
export default function CompetitorAnalysisCard({ competitorAnalyses }: CompetitorAnalysisCardProps) {
  return (
    <Card className="bg-gradient-to-r from-orange-50 to-yellow-50 border-orange-200 dark:from-slate-900 dark:to-slate-800 dark:border-slate-700">
          ...
          <div key={index} className="bg-card p-4 rounded-lg border">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
              <div className="text-center">
                <div className="font-bold text-orange-600 dark:text-orange-400">{analysis.followers?.toLocaleString() || 'N/A'}</div>
                <div className="text-xs text-muted-foreground">Followers</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-orange-600 dark:text-orange-400">{analysis.engagement_rate?.toFixed(2) || 'N/A'}%</div>
                <div className="text-xs text-muted-foreground">Engagement</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-orange-600 dark:text-orange-400">{Math.round(analysis.avg_likes || 0).toLocaleString()}</div>
                <div className="text-xs text-muted-foreground">Avg Likes</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-orange-600 dark:text-orange-400">{analysis.posts || 'N/A'}</div>
