      ...
      <div className="flex items-end space-x-3 max-w-4xl mx-auto">
        ...
        <div className="flex-1 relative">
          <Textarea
            ...
            placeholder=""
            className="min-h-[36px] max-h-[100px] resize-none border border-input rounded-xl px-4 py-2 pr-12 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent placeholder-muted-foreground text-sm leading-normal overflow-y-auto bg-background text-foreground"
            disabled={disabled}
