      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-foreground">ContentCraft AI</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
              ...
              <h3 className="text-lg font-semibold text-card-foreground mb-2">Smart Conversations</h3>
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
              ...
              <h3 className="text-lg font-semibold text-card-foreground mb-2">Platform Optimization</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
              ...
              <h3 className="text-lg font-semibold text-card-foreground mb-2">Audience Insights</h3>
              <p className="text-muted-foreground">
