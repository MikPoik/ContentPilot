  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50/50 via-emerald-50/30 to-teal-50/50 dark:from-gray-950 dark:via-slate-950 dark:to-gray-900">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 sm:pt-24 sm:pb-32">
        <div className="absolute inset-0 bg-gradient-to-b from-emerald-100/80 via-teal-50/40 to-transparent dark:from-slate-900/80 dark:via-gray-950/40 dark:to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-100/30 via-emerald-50/20 to-transparent dark:from-transparent dark:via-transparent dark:to-transparent" />
